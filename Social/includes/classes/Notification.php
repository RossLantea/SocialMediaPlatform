...
class Notification {
    ...
    //Hae lukemattomien ilmoitusten määrä
	...
	public function getNotifications($data, $limit) {
		...
		while($row = mysqli_fetch_array($query)) {
			...
			$start_date = new DateTime($row['datetime']); //Postauksen päivämäärä
			$end_date = new DateTime($date_time_now); //Tämänhektinen päivämäärä
