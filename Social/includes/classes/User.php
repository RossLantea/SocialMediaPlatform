...
class User {
    ...
    //Hae ja palauta käyttäjänimi
	public function getUsername() {
		return $this->user['username'];
	}
     //Hae ja palauta kaveripyyntöjen määrä
    ...
    //Hae ja palauta postausten määrä
    ...
    //Ota ja palauta etu ja sukunimi
    ...
    //Käyttäjä aktiivinen vai sulkenut tilin
    ...
    //Hae ja palauta yhteiset kaverit
