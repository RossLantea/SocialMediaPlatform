...
class Message {
    ...
    //Hae ja palauta viimeisin käyttäjä
	...
	public function getLatestMessage($userLoggedIn, $user2) {
		...
		$start_date = new DateTime($row['date']); //Postauksen päivämäärä
	...
	public function getConvos() {
     ...
     //Keskustelujen pudotuspalkki valikko
 ...
 // jos määrä ylittyy ladattavien viestien määrässä break (leave the loop)
			...
			//jos open on Ei, eli ei ole avattu SET taustaväri
